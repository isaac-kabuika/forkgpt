...
const LlmResponseRequestedSchema = z.object({ "messages": z.array(z.object({ "role": z.enum(["user","assistant"]), "content": z.string() }).strict()), "requestorCorrelationId": z.string() }).strict();
