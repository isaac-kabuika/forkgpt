...
const ThreadCreateSchema = z.object({ "id": z.string().optional(), "name": z.string(), "leafMessageId": z.union([z.string(), z.null()]).optional(), "topicId": z.string(), "userId": z.string(), "accessToken": z.string(), "leftThreadId": z.union([z.string(), z.null()]).optional(), "rightThreadId": z.union([z.string(), z.null()]).optional(), "newMessageContent": z.string() }).strict();
